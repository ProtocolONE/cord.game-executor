...
#ifndef _GGS_GAMEEXECUTOR_VERSION_H_
#define _GGS_GAMEEXECUTOR_VERSION_H_
    ...
    #define FILEDESCRIPTION  "Developer version of GameNet GameExecutor library"
    ...
    #define PRODUCTNAME      "GameNet GameExecutor library"
#else
...
#endif //_GGS_GAMEEXECUTOR_VERSION_H_
