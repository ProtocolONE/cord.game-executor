...
#define _GGS_RESTAPI_VERSION_H_
    ...
    #define FILEDESCRIPTION  "Developer version of GameNet GameExecutor Launcher"
    #define INTERNALNAME     "Launcher"
    #define LEGALCOPYRIGHT   "Copyright(c) 2010 - 2012"

    #ifdef DEBUG 
        #define ORIGINALFILENAME "Launcher.exe"
    #else
        #define ORIGINALFILENAME "Launcher.exe"
    #endif

    #define PRODUCTNAME      "GameNet GameExecutor Launcher"
#else
