...
#    version = "1.0"
    ...
    requires = "Qt/5.5.1@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable", "RestApi/1.0.0@common/stable", "Application/1.0.0@common/stable"
    build_requires = "Qt/5.5.1@common/stable", "Core/1.0.0@common/stable", "Settings/1.0.0@common/stable", "RestApi/1.0.0@common/stable", "Application/1.0.0@common/stable"
